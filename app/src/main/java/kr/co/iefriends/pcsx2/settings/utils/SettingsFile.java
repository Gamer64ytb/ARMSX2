package kr.co.iefriends.pcsx2.settings.utils;
...
public final class SettingsFile
{
  ...
  public static void saveFile(final String fileName, TreeMap<String, SettingSection> sections)
  {
    ...
    {
      DebugLog.e("SettingsFile", "File not found: " + fileName + ".ini: " + e.getMessage());
    }
    catch (UnsupportedEncodingException e)
    {
      DebugLog.e("SettingsFile", "Bad encoding; please file a bug report: " + fileName + ".ini: " +
        e.getMessage());
    }
    finally
    {
